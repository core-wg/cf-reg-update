...
Once the required review procedure for the temporary ID has successfully completed, and the referenced media type is included in the IANA Media Types registry {{IANA.media-types}}, IANA must remove the any indication about the temporary nature of the registration so that the entry becomes permanent.
